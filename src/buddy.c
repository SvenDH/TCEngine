...
tc_allocator_i* cache_create(tc_allocator_i* a, uint32_t size, uint32_t min_size, uint32_t slab_size)
{
...
void cache_destroy(tc_allocator_i* a)
{
...
tc_buddy_i* tc_buddy = &(tc_buddy_i){
	.create = cache_create,
