...
TIF_CONSTEXPR inline bool TinyImageFormat_DecodeLogicalPixelsF(TinyImageFormat const fmt, struct TinyImageFormat_DecodeInput * in, uint32_t const width, float* out) {
	switch(fmt) {
...
TIF_CONSTEXPR inline bool TinyImageFormat_DecodeLogicalPixelsD(TinyImageFormat const fmt, struct TinyImageFormat_DecodeInput * in, uint32_t const width, double* out) {
	switch(fmt) {
